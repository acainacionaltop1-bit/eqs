...
export default function Login() {
  const { redirectToLogin, isFetching, isRedirecting } = useAuth();
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Login successful, wait a moment then redirect to dashboard
        setTimeout(() => {
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <button
          ...
          disabled={isFetching || isRedirecting}
        ...
        {isRedirecting && (
          <div className="bg-blue-500/10 border border-blue-500/30 rounded-2xl p-3 text-center">
            <p className="text-blue-400 text-sm">
              💡 Aguarde... Você será redirecionado para o Google. Se demorar muito, tente usar o login por email abaixo.
            </p>
          </div>
        )}
