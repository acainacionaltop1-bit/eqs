...
export default function CadastroPage() {
  ...
  const handleGoogleSignup = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      ...
      options: {
        ...
        queryParams: formData.affiliateCode ? {
          referred_by: formData.affiliateCode,
        } : undefined,
      },
    })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const { error } = await supabase.auth.signUp({
      ...
      options: {
        ...
        data: {
          ...
          referred_by: formData.affiliateCode || null,
        },
      },
    })
    ...
    // Redirect to success page or directly to home
        ...
        <form onSubmit={handleSubmit} className="space-y-3">
          ...
          <FormField label="Código de indicação (opcional)">
            <Input
              ...
              name="affiliateCode"
              type="text"
              placeholder="Digite o código se foi convidado"
              value={formData.affiliateCode}
              onChange={handleInputChange}
              autoCapitalize="characters"
            />
            {formData.affiliateCode && (
              <div className="text-xs text-muted-foreground bg-primary/10 border border-primary/20 rounded-lg p-2 mt-2">
